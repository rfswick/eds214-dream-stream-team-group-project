...
ggplot(data_sub, aes(x = date, y = k, color = sample_id)) + 
  geom_line(linewidth = 0.5) + 
  ggplot(data_sub, aes(x = date, y = no3, color = sample_id)) + 
  geom_line(linewidth = 0.5)
...
patch_graph <- (k_plot + theme(axis.title.x = element_blank(), axis.text.x = element_blank(), axis.ticks.x = element_blank())) / (no3_plot + theme(axis.title.x = element_blank()))
